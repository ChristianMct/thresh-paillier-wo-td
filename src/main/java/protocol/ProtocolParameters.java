...
public class ProtocolParameters {
	...
	private ProtocolParameters(BigInteger P, BigInteger Pp, BigInteger g, BigInteger gp, BigInteger h, int t, int k, int K) {
		this.P = P;
		this.Pp = Pp;
		this.g = g;
		this.gp = gp;
	...
	public static ProtocolParameters gen(int k, SecureRandom sr) {
		...
		return new ProtocolParameters(P, Pp, g, null,h, 4, k, 1000);
	}
}
